...
import '../Styleconfiguraciones.css';
...
export function Configuraciones() {
  ...
  const handleNavButtonClick = (section) => {
    setShowConfiguraciones(section === 'configuraciones');
  };
  ...
  return (
    <div className={`App ${showConfiguraciones ? 'configuraciones-active' : ''}`}>
      {showConfiguraciones && (
        <>
      ...
      <div className={`bottom-nav ${showConfiguraciones ? '' : 'full-screen'}`}>
        <button className="nav-button" onClick={() => handleNavButtonClick('inicio')}>Inicio</button>
        <button className="nav-button" onClick={() => handleNavButtonClick('chats')}>Chats</button>
        <button className="nav-button" onClick={() => handleNavButtonClick('historia')}>Historia</button>
        <button className="nav-button" onClick={() => handleNavButtonClick('publicar')}>Publicar</button>
        <button className="nav-button" onClick={() => handleNavButtonClick('perfil')}>Perfil</button>
        <button className="nav-button" onClick={() => handleNavButtonClick('configuraciones')}>Configuraciones</button>
      </div>
    </div>
  );
}
